...
Command: npx gltfjsx@6.5.3 public/final_model.gltf 
*/
...
export function Model({ onPointerOver, onPointerOut, onClick, ...props }) {
  const { scene } = useGLTF("/final_model.gltf");
...
useGLTF.preload("/final_model.gltf");
